  ...
  useEffect(() => {
    if (!isEmpty(jobData)) {
      ...
      setInput({
        ...
        job_responsibilities: jobData.job_responsibilities?.map(
          (item) => item.name
        ),
        ...
        expired_at: dayjs(jobData.expired_at, "YYYY-MM-DD HH:mm:ss").format(
          "YYYY-MM-DD HH:mm"
        ),
        islamic_env: jobData.islamic_env,
        is_display_salary: jobData.is_display_salary,
      });
    }
  }, [jobData]);
              ...
              <div className="ml-6">
                ...
                >
                  <TimePicker.RangePicker
                    ...
                    className="py-2"
                    defaultValue={parseJamKerja(jobData.jam_kerja)}
                    disabled={!edit}
                    size="large"
                  />
                </FormItem>
