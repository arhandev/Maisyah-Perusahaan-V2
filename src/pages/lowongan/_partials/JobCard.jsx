...
function JobCard({ company, job, setJobData }) {
  ...
  return (
    <div
      className={`flex flex-col shadow-md rounded-lg border-solid border-2 border-r-8 border-r-${checkColor()} border-gray-300 text-xl p-6 cursor-pointer`}
      onClick={onClickJob}
    >
      <Tag />
